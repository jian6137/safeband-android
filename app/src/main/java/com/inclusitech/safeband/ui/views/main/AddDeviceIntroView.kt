...
fun AddDeviceIntro(
    ...
    val composition by rememberLottieComposition(LottieCompositionSpec.RawRes(R.raw.add_device_anim))
    ...
    Surface {
        Column(
            ...
            Text(
                text = "Let's start adding your new SafeBand Product",
            ...
            Column(
                ...
                Button(
                    modifier = Modifier
                        ...
                        .fillMaxWidth(),
                    onClick = {
                        navHostController.navigate(MainRoutes.AddNewDeviceView.route)
                    },
                ) {
                    Text("Continue")
                }
